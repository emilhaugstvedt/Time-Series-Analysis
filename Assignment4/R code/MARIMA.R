...
Marima_new <- step.slow(Marima, dlog.training_data, penalty=3.92, max.iter=10)
...
predict_test_z2000 <- ts(untransformed_forecast[1, 115:118], start = 2020.75, frequency = 4)
predict_test_z2800 <- ts(untransformed_forecast[2, 115:118], start = 2020.75, frequency = 4)
predict_test_z4000 <- ts(untransformed_forecast[3, 115:118], start = 2020.75, frequency = 4)
predict_test_z4200 <- ts(untransformed_forecast[4, 115:118], start = 2020.75, frequency = 4)

# Plot predictions on test data:
par(mfrow=c(2,2))
plot(ts(test_data[1, ], start = 2020.75, frequency = 4), type= "l",
     main= "True vs. Pred z2000 test data", col= "orange",
     ylabels= "Price", ylim = c(40000, 90000))
lines(predict_test_z2000, type= "l", col= "Blue")
lines(ts(pred_interval.z2000[1,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
lines(ts(pred_interval.z2000[2,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
legend("topleft", c("True", "Prediction", "Prediction interval"), fill= c("orange", "blue", "red"))

plot(ts(test_data[2, ], start = 2020.75, frequency = 4), type= "l",
     main= "True vs. Pred z2800 test data", col= "orange",
     ylabels= "Price", ylim = c(30000, 55000))
lines(predict_test_z2800, type= "l", col= "Blue")
lines(ts(pred_interval.z2800[1,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
lines(ts(pred_interval.z2800[2,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
legend("topleft", c("True", "Prediction", "Prediction interval"), fill= c("orange", "blue", "red"))

plot(ts(test_data[3, ], start = 2020.75, frequency = 4), type= "l",
     main= "True vs. Pred z4000 test data", col= "orange",
     ylabels= ("Price"), ylim = c(17500, 30000))
lines(predict_test_z4000, type= "l", col= "Blue")
lines(ts(pred_interval.z4000[1,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
lines(ts(pred_interval.z4000[2,], start = 2020.75, frequency = 4), type = "l", lty=2,  col = "red")
legend("topleft", c("True", "Prediction", "Prediction interval"), fill= c("orange", "blue", "red"))

plot(ts(test_data[4, ], start = 2020.75, frequency = 4), type= "l",
...
lines(ts(pred_interval.z4200[1,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
lines(ts(pred_interval.z4200[2,], start = 2020.75, frequency = 4), type = "l", lty=2, col = "red")
legend("topleft", c("True", "Prediction", "Prediction interval"), fill= c("orange", "blue", "red"))
